	...
	<h3 style="text-transform:uppercase;border-bottom: 1px solid #ccc;"><?php _e("Rewriting","wprobot") ?></h3>
		...
		<table class="addt" width="100%" cellspacing="2" cellpadding="5" class="editform"> 		
			<tr valign="top"> 
				...
				<td>	
				<input name="wpr_rewrite_active_tbs" type="checkbox" value="1" id="tbs" <?php if ($options['wpr_rewrite_active_tbs']=='1') {echo 'checked';} ?>> <label for="tbs">TheBestSpinner</a><br/>
				<input name="wpr_rewrite_active_sc" type="checkbox" value="1" id="sc" <?php if ($options['wpr_rewrite_active_sc']=='1') {echo 'checked';} ?>> <label for="sc">SpinnerChief</a> <br/>
				<input name="wpr_rewrite_active_schimp" type="checkbox" value="1" id="schimp" <?php if ($options['wpr_rewrite_active_schimp']=='1') {echo 'checked';} ?>> <label for="schimp">SpinChimp</a> <br/>
				<input name="wpr_rewrite_active_sr" type="checkbox" value="1" id="sr" <?php if ($options['wpr_rewrite_active_sr']=='1') {echo 'checked';} ?>> <label for="sr">Spin Rewriter</a> <br/>				
				<input name="wpr_rewrite_active_ucg" type="checkbox" value="1" id="Yes" <?php if ($options['wpr_rewrite_active_ucg']=='1') {echo 'checked';} ?>> <label for="Yes">UCG</a> <br/>
