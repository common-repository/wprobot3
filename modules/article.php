	...
	<h3 style="text-transform:uppercase;border-bottom: 1px solid #ccc;"><?php _e("Article Options","wprobot") ?></h3>
		<table class="addt" width="100%" cellspacing="2" cellpadding="5" class="editform"> 	
			...
			<tr valign="top"> 
				...
				<td>
				<input name="wpr_eza_source_ab" type="checkbox" value="1" id="ab" <?php if ($options['wpr_eza_source_ab']=='1') {echo 'checked';} ?>> <label for="ab"><?php _e("Ezinearticles.com","wprobot") ?></a><br/>
				<input name="wpr_eza_source_goa" type="checkbox" value="1" id="goa" <?php if ($options['wpr_eza_source_goa']=='1') {echo 'checked';} ?>> <label for="goa"><?php _e("Goarticles.com","wprobot") ?></a> <br/>
				<!--<input name="wpr_eza_source_buk" type="checkbox" value="1" id="buk" <?php if ($options['wpr_eza_source_buk']=='1') {echo 'checked';} ?>> <label for="buk"><?php _e("Bukisa.com","wprobot") ?></a> <br/>-->
				<input name="wpr_eza_source_ezm" type="checkbox" value="1" id="ezm" <?php if ($options['wpr_eza_source_ezm']=='1') {echo 'checked';} ?>> <label for="ezm"><?php _e("Ezinemark.com","wprobot") ?></a> <br/>				
