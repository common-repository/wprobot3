...
function wpr_bigcontentsearch_options($options) {
	...
	<p><i>Important: <a href="http://thoefter.niteowebbig9.click2sell.eu/?id=wprobot" target="_blank">BigContentSearch.com Account required</a></i></p>	
		...
		<table class="addt" width="100%" cellspacing="2" cellpadding="5" class="editform"> 
			<tr <?php if($options['wpr_bcs_email'] == "") {echo 'style="background:#F8E0E0;"';} ?> valign="top"> 
				...
				<!--Tooltip--><a target="_blank" class="tooltip" href="http://thoefter.niteowebbig9.click2sell.eu/?id=wprobot">?<span><?php _e('This setting is required for the Big Content Search module to work!<br/><br/><b>Click to go to the Big Content Search sign up page!</b>',"wprobot") ?></span></a>
			</td> 
			</tr>	
